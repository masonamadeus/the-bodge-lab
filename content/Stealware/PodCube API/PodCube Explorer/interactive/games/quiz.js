...
class QuizGame extends Game {
    ...
    constructor(api) {
        ...
        this.allQuestions = [
            ...
            { q: "What is the slogan of Wexton Industries' Tall Building Design department?", a: ["Build high, touch the sky", "Tall, no fall", "Stability through height"], c: 1 },
            ...
            { q: "Which procurement company deals in rare fruit, vegetables, and extremely rare insects?", a: ["SQUIRT", "Sprott Corp", "Wexton Logistics"], c: 0 },
            ...
            { q: "In the elevator crisis at Lease on Life Apartments, what item is suggested as a solution for the trapped victim?", a: ["A ladder", "A futon", "A raccoon"], c: 1 },
            ...
            { q: "What is the secret ingredient for the 'Tiramisu Tuesday' finale on the show 'Cookin'?", a: ["Hazelnuts", "Mustard and a beet", "Sprott and lead"], c: 1 },
            { q: "Where does the 'Cookin' contestant Naples Florida actually grow up?", a: ["Naples, Florida", "Des Moines, Iowa", "Chelsea, New York"], c: 1 },
            { q: "What promo code provides six months of free Twibby Max Prime?", a: ["PODCUBE360", "HYPERSMOOTH", "GLEEPGLORP"], c: 1 },
            { q: "The sci-fi writer Jeff claims to have been the head writer for which major film?", a: ["The Matrix 4", "Shrek 5", "Dune 4"], c: 1 },
            ...
            { q: "What planet is the origin for the KitFox War Machine cockpit recording?", a: ["Joe Boris IV", "Vandross 5", "Mars"], c: 0 },
            ...
            { q: "What did a PodCube employee find stuck 'back in the behind' of a computer fan flap?", a: ["A french fry", "An onion ring", "A CoreN fuel cell"], c: 1 },
            { q: "The board game 'Dream Phone 2' gives a clue about the aperture of what device?", a: ["A PodCube", "A camera", "A flip phone"], c: 1 },
            ...
            { q: "What is the 'Sprott Minimum' beverage?", a: ["Sprott for kids", "Sprott with only 11,000 minerals", "Clear Sprott"], c: 1 },
