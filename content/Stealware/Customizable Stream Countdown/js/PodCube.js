 ...
 */
    ...
    /**
     * DECOMPRESS: Unpacks 20-bit stream
     */
    _decompressPlaylist(code) {
        ...
        try {
            ...
            const [name64, ids64] = parts;

            // 1. Decode Name
            const name = decodeURIComponent(escape(atob(name64.replace(/-/g, '+').replace(/_/g, '/'))));

            // 2. Decode Payload -> Binary String
